...
class VisionServoNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('lateral_kd', 0.0)
        self.declare_parameter('vertical_kp', 0.0)
        self.declare_parameter('vertical_ki', 0.0)
        self.declare_parameter('vertical_kd', 0.0)
        self.declare_parameter('range_kp', 0.0)
        self.declare_parameter('range_ki', 0.0)
        self.declare_parameter('range_kd', 0.0)
